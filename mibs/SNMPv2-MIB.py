...
# Notes
# -----
# ASN.1 source file://mibs\SNMPv2-MIB.mib
# Produced by pysmi-1.5.5 at Sun Oct 27 23:14:30 2024
# On host BRN0122COKL141 platform Windows version 10 by user BhadraMohan
...
snmpCommunityGroup1 = ObjectGroup(
    (1, 3, 6, 1, 6, 3, 1, 2, 2, 9)
)
snmpCommunityGroup1.setObjects(
      *(("SNMPv2-MIB", "snmpInBadCommunityNames"),
        ("SNMPv2-MIB", "snmpInBadCommunityUses"))
)
if mibBuilder.loadTexts:
    snmpCommunityGroup1.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"system": system,
       ...
       "snmpGroup": snmpGroup,
       "snmpCommunityGroup1": snmpCommunityGroup1,
